...
contract mTKNExample is mTKN, ERC20, ERC20Detailed, mTKNDomain {
    ...
    internal {
        ...
        ERC20._approve(mtransfer_from.sender, mtransfer_from.actors.signer, ERC20.allowance(mtransfer_from.sender, mtransfer_from.actors.signer).sub(mtransfer_from.amount));
